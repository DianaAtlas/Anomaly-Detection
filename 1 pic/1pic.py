...
#     data_bg = np.random.poisson(1 * bground, np.array(numofevents_1).size)
#
#     return data_si_bg, data_bg
...
print('presantage', sum_00/numofexampls, '+-', math.sqrt(sum_00/numofexampls) )
...
print('presantage', manualsum_00 / numofexampls,'+-', math.sqrt(manualsum_00/numofexampls))
