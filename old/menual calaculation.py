...
# plt.plot(np.histogram(manual_00, bins=200))
# plt.plot(np.histogram(manual_01, bins=200))
# plt.show()

manualmedian_00 = np.median(manual_01)

manualsum_00 = sum_all_values_over(manual_00, manualmedian_00)
print(manualsum_00)

print('#of values after median', manualsum_00)
...
# def sumyedanit(array, from1 , to):
#     i = from1
#     for i in range(to):
#      numofevents1 += array[from1]
#     return numofevents1
#
#
# printed= sumyedanit(data_testing_01_norm, mu)
...
#------trying one model layer-------------------


# model = Sequential()
# model.add(Dense(10, batch_size=50,
#                 activation= 'relu',
#                 kernel_regularizer=regularizers.l2(0.0001)))    # Kernel Regularization regulates the weights
#
#
...
#
#
# #-----------calculating the p value via counting
#
